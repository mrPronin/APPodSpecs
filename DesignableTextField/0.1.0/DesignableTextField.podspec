#
#  Be sure to run `pod spec lint DesignableTextField.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/mrPronin/DesignableTextField.git", :tag => "#{s.version}" }
  ...
  # s.resource  = "icon.png"
  s.resources = "DesignableTextField/**/*.{png,jpeg,jpg,storyboard,xib}"
